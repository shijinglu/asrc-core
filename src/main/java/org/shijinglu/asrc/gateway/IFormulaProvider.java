 ...
 *
 * This interface isolates the Formula providing logic from Formula using logic. And it
 * should take care of cache and caching consistency among different hosts.
 */
public interface IFormulaProvider {
     ...
     * @return formula
     */
    Formula getFormula(String namespace, String key);
}
